      ...
      <div class="relative flex justify-between h-24">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          <nuxt-link to="/" class="flex-shrink-0 flex items-center">
            <img class="block lg:hidden h-6 w-auto" src="FA.svg" alt="Forum des associations">
            <img class="hidden lg:block h-6 w-auto" src="FA.svg" alt="Forum des associations">
            <span class="text-blue-900 hidden md:inline ml-2">Forum des associations</span>
          </nuxt-link>
